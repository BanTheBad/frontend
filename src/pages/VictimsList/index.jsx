...
import { TopNav, Button, AccusedCard } from '../../unit-components';
...
function VictimsList() {
  ...
  return (
    <div>
      <TopNav mode="withoutLinks" />
      <div className="details-header bg-dark" style={{ paddingRight: '14px', paddingLeft: '14px' }}>
        <div
          className={`section ${
      ...
      {activeSection === "victims" ? 
        <Victims /> :
        <div style={{ paddingRight: '14px', paddingLeft: '14px', paddingTop: '14px' }}>
